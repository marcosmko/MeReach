...
public final class CoreDataManager {
    ...
    private lazy var persistentContainer: NSPersistentContainer = {
        ...
        guard let bundle = Bundle.main.url(forResource: "MeReach", withExtension: "momd") else {
        ...
        let container: NSPersistentContainer = NSPersistentContainer(name: "MeReach", managedObjectModel: objectModel)
